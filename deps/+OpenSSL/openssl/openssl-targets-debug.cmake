...
if(WIN32)
	...
	message("import debug openssl on windows with libssl${_lib_extension}")
else()
	set(_lib_extension ".a")
	message("import debug openssl on linux/mac with libssl${_lib_extension}")
endif()
...
set_target_properties(OpenSSL::SSL PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libssl${_lib_extension}"
  )
...
set_target_properties(OpenSSL::Crypto PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libcrypto${_lib_extension}"
  )
